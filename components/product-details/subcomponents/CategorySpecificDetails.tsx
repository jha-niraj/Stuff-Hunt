            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  {specs.fit === 'Slim' && ' It\'s designed to be close-fitting for a tailored look.'}
                  {specs.fit === 'Relaxed' && ' It offers a comfortable, loose fit with room to move.'}
                  {specs.fit === 'Regular' && ' It provides a comfortable fit that\'s not too tight or too loose.'}
                </p>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {specs.care && specs.care.length > 0 ? (
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {specs.care.map((instruction: string, index: number) => (
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <h5 className="font-medium mb-2">Material: {specs.material || product.material || 'Cotton Blend'}</h5>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Performance Section */}
              {(specs.processor || specs.ram || specs.storage || specs.graphics) && (
